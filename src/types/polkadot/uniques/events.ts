...
export const issued =  {
    ...
    v601: new EventType(
        'Uniques.Issued',
        sts.tuple([sts.number(), sts.number(), v601.AccountId32])
    ),
    /**
...
export const transferred =  {
    ...
    v601: new EventType(
        'Uniques.Transferred',
        sts.tuple([sts.number(), sts.number(), v601.AccountId32, v601.AccountId32])
    ),
    /**
...
export const teamChanged =  {
    ...
    v601: new EventType(
        'Uniques.TeamChanged',
        sts.tuple([sts.number(), v601.AccountId32, v601.AccountId32, v601.AccountId32])
    ),
    /**
...
export const classMetadataSet =  {
    ...
    v601: new EventType(
        ...
        sts.tuple([sts.number(), v601.BoundedVec, sts.boolean()])
    ),
    /**
...
export const metadataSet =  {
    ...
    v601: new EventType(
        'Uniques.MetadataSet',
        sts.tuple([sts.number(), sts.number(), v601.BoundedVec, sts.boolean()])
    ),
    /**
     * New metadata has been set for an asset instance.
     */
...
export const attributeSet =  {
    ...
    v601: new EventType(
        ...
        sts.tuple([sts.number(), sts.option(() => sts.number()), sts.bytes(), sts.bytes()])
    ),
    /**
     * New attribute metadata has been set for an asset class or instance.
     */
...
export const attributeCleared =  {
    ...
    v601: new EventType(
        ...
        sts.tuple([sts.number(), sts.option(() => sts.number()), sts.bytes()])
    ),
    /**
     * Attribute metadata has been cleared for an asset class or instance.
     */
