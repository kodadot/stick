...
export const teamChanged =  {
    ...
    v9420: new EventType(
        ...
        sts.struct({
            collection: sts.number(),
            issuer: sts.option(() => v9420.AccountId32),
            admin: sts.option(() => v9420.AccountId32),
            freezer: sts.option(() => v9420.AccountId32),
        })
    ),
}
...
export const itemPriceSet =  {
    ...
    v9420: new EventType(
        ...
        sts.struct({
            ...
            item: sts.number(),
            price: sts.bigint(),
            whitelistedBuyer: sts.option(() => v9420.AccountId32),
        })
    ),
}
...
export const itemBought =  {
    ...
    v9420: new EventType(
        ...
        sts.struct({
            ...
            item: sts.number(),
            price: sts.bigint(),
            seller: v9420.AccountId32,
            buyer: v9420.AccountId32,
        })
    ),
}
...
export const tipSent =  {
    ...
    v9420: new EventType(
        ...
        sts.struct({
            collection: sts.number(),
            item: sts.number(),
            sender: v9420.AccountId32,
            receiver: v9420.AccountId32,
            amount: sts.bigint(),
        })
    ),
}
...
export const swapCreated =  {
    ...
    v9420: new EventType(
        ...
        sts.struct({
            ...
            price: sts.option(() => v9420.PriceWithDirection),
            deadline: sts.number(),
        })
    ),
}
...
export const swapClaimed =  {
    ...
    v9420: new EventType(
        ...
        sts.struct({
            ...
            sentItem: sts.number(),
            sentItemOwner: v9420.AccountId32,
            receivedCollection: sts.number(),
            receivedItem: sts.number(),
            receivedItemOwner: v9420.AccountId32,
            price: sts.option(() => v9420.PriceWithDirection),
            deadline: sts.number(),
        })
    ),
