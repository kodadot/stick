...
export class NftsAllApprovalsCancelledEvent {
     ...
     * All approvals of an item got cancelled.
     */
    get asV9430(): {collection: number, item: number, owner: Uint8Array} {
        assert(this.isV9430)
...
export class NftsApprovalCancelledEvent {
     ...
     * `collection` was cancelled by its `owner`.
     */
    get asV9430(): {collection: number, item: number, owner: Uint8Array, delegate: Uint8Array} {
        assert(this.isV9430)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class NftsAttributeClearedEvent {
     ...
     * Attribute metadata has been cleared for a `collection` or `item`.
     */
    get asV9430(): {collection: number, maybeItem: (number | undefined), key: Uint8Array, namespace: v9430.AttributeNamespace} {
        assert(this.isV9430)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class NftsAttributeSetEvent {
     ...
     * New attribute metadata has been set for a `collection` or `item`.
     */
    get asV9430(): {collection: number, maybeItem: (number | undefined), key: Uint8Array, value: Uint8Array, namespace: v9430.AttributeNamespace} {
        assert(this.isV9430)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class NftsCollectionMaxSupplySetEvent {
     ...
     * Max supply has been set for a collection.
     */
    get asV9430(): {collection: number, maxSupply: number} {
        assert(this.isV9430)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class NftsCollectionMetadataSetEvent {
     ...
     * New metadata has been set for a `collection`.
     */
    get asV9430(): {collection: number, data: Uint8Array} {
        assert(this.isV9430)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class NftsCreatedEvent {
     ...
     * A `collection` was created.
     */
    get asV9430(): {collection: number, creator: Uint8Array, owner: Uint8Array} {
        assert(this.isV9430)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class NftsForceCreatedEvent {
     ...
     * A `collection` was force-created.
     */
    get asV9430(): {collection: number, owner: Uint8Array} {
        assert(this.isV9430)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class NftsItemAttributesApprovalAddedEvent {
     ...
     * A new approval to modify item attributes was added.
     */
    get asV9430(): {collection: number, item: number, delegate: Uint8Array} {
        assert(this.isV9430)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class NftsItemBoughtEvent {
     ...
     * An item was bought.
     */
    get asV9430(): {collection: number, item: number, price: bigint, seller: Uint8Array, buyer: Uint8Array} {
        assert(this.isV9430)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class NftsItemMetadataClearedEvent {
     ...
     * Metadata has been cleared for an item.
     */
    get asV9430(): {collection: number, item: number} {
        assert(this.isV9430)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class NftsItemMetadataSetEvent {
     ...
     * New metadata has been set for an item.
     */
    get asV9430(): {collection: number, item: number, data: Uint8Array} {
        assert(this.isV9430)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class NftsItemPriceSetEvent {
     ...
     * The price was set for the item.
     */
    get asV9430(): {collection: number, item: number, price: bigint, whitelistedBuyer: (Uint8Array | undefined)} {
        assert(this.isV9430)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class NftsItemPropertiesLockedEvent {
     ...
     * `item` metadata or attributes were locked.
     */
    get asV9430(): {collection: number, item: number, lockMetadata: boolean, lockAttributes: boolean} {
        assert(this.isV9430)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class NftsOwnerChangedEvent {
     ...
     * The owner changed.
     */
    get asV9430(): {collection: number, newOwner: Uint8Array} {
        assert(this.isV9430)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class NftsOwnershipAcceptanceChangedEvent {
     ...
     * Ownership acceptance has changed for an account.
     */
    get asV9430(): {who: Uint8Array, maybeCollection: (number | undefined)} {
        assert(this.isV9430)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class NftsPalletAttributeSetEvent {
     ...
     */
    get isV9430(): boolean {
        return this._chain.getEventHash('Nfts.PalletAttributeSet') === '468a1a89b31826460104c40759efeb63ceefdd69a6f12d9f82160b20376b0cb6'
    }
     ...
     * within that `collection`.
     */
    get asV9430(): {collection: number, item: (number | undefined), attribute: v9430.PalletAttributes, value: Uint8Array} {
        assert(this.isV9430)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class NftsPreSignedAttributesSetEvent {
     ...
     * New attributes have been set for an `item` of the `collection`.
     */
    get asV9430(): {collection: number, item: number, namespace: v9430.AttributeNamespace} {
        assert(this.isV9430)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class NftsSwapCancelledEvent {
     ...
     * The swap was cancelled.
     */
    get asV9430(): {offeredCollection: number, offeredItem: number, desiredCollection: number, desiredItem: (number | undefined), price: (v9430.PriceWithDirection | undefined), deadline: number} {
        assert(this.isV9430)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class NftsSwapClaimedEvent {
     ...
     * The swap has been claimed.
     */
    get asV9430(): {sentCollection: number, sentItem: number, sentItemOwner: Uint8Array, receivedCollection: number, receivedItem: number, receivedItemOwner: Uint8Array, price: (v9430.PriceWithDirection | undefined), deadline: number} {
        assert(this.isV9430)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class NftsTeamChangedEvent {
     ...
     * The management team changed.
     */
    get asV9430(): {collection: number, issuer: (Uint8Array | undefined), admin: (Uint8Array | undefined), freezer: (Uint8Array | undefined)} {
        assert(this.isV9430)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class NftsTipSentEvent {
     ...
     * A tip was sent.
     */
    get asV9430(): {collection: number, item: number, sender: Uint8Array, receiver: Uint8Array, amount: bigint} {
        assert(this.isV9430)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class NftsTransferApprovedEvent {
     ...
     * a `delegate`.
     */
    get asV9430(): {collection: number, item: number, owner: Uint8Array, delegate: Uint8Array, deadline: (number | undefined)} {
        assert(this.isV9430)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class NftsTransferredEvent {
     ...
     * An `item` was transferred.
     */
    get asV9430(): {collection: number, item: number, from: Uint8Array, to: Uint8Array} {
        assert(this.isV9430)
        return this._chain.decodeEvent(this.event)
    }
}
